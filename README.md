...
NIST National Vunerability Database (NVD) LinkML Schema

## Documentation Website

[https://lmodel.github.io/nist-nvd](https://lmodel.github.io/nist-nvd)
...
* [src/](src/) - source files (edit these)
  * [nist_nvd](src/nist_nvd)
    * [schema/](src/nist_nvd/schema) -- LinkML schema
      (edit this)
    * [datamodel/](src/nist_nvd/datamodel) -- generated
      Python datamodel
