# Contributing to nist-nvd

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
nist-nvd. These guidelines are not strict rules.
...
The nist-nvd team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the nist-nvd technical leads
...
[issues]: https://github.com/lmodel/nist-nvd/issues/
[pulls]: https://github.com/lmodel/nist-nvd/pulls/
